...
def multiples_of(factors, cap):
	'''
	Returns a list of natural numbers that are multiples of given factors under the cap
	'''
	multiples = set()
	...
	while True:
		...
		if not some_multiple_within_cap:
			...
			current_multiples = [current_multiples[i] + factor for i, factor in enumerate(factors)]
